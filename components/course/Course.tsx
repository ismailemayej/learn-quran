...
const Course: React.FC = () => {
  return (
    <div className="bangla lg:my-6 my-2 bg-gradient-to-r from-gray-100 via-gray-200 to-white dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-gray-200 rounded-lg shadow-xl mx-auto p-6 space-y-6 transition-colors duration-300">
      {/* Heading */}
